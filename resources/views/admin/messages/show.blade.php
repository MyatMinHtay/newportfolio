...
@section('content')
    ...
    >
        <x-slot:actions>
            <a href="mailto:{{ $message->email }}?subject={{ urlencode('Re: ' . ($message->subject ?: 'Inquiry')) }}" class="btn btn-primary">
            ...
            <x-card class="shadow-sm">
                <div class="mb-4 pb-3 border-bottom">
                    <div class="d-flex justify-content-between align-items-start gap-3">
                        <div>
                            <h4 class="h5 fw-bold mb-1" style="color: var(--pf-text);">{{ $message->subject ?: '(No Subject)' }}</h4>
                ...
                <div class="p-3 rounded-3" style="background-color: var(--pf-surface-muted); min-height: 200px; white-space: pre-wrap; font-size: 1rem; line-height: 1.6; color: var(--pf-text);">{{ $message->message }}</div>
